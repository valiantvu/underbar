...
(function() {
  ...
  _.some = function(collection, iterator) {
    ...
    // return _.every(collection, function(previousValue, item){
    //   return !iterator(previousValue, item);
    // });
    return _.reduce(collection, function(wasMatched, item) {
      if (wasMatched){
        return true;
  ...
  _.memoize = function(func) {
    ...
    return function(input){
      return cache[input] === undefined ? cache[input] = func(input) : cache[input];
    }
  ...
  _.delay = function(func, wait) {
    ...
    return setTimeout(function() { return func.apply(null, input); }, wait);
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = 0; i < 100; i++){
      ...
      var temp = shuffled[rand];
      shuffled[rand] = shuffled[rand + 1];
      shuffled[rand + 1] = temp;
    }
    return shuffled;
  };
